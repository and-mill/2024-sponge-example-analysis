"""
This Code was copied from [sponge-examples](https://github.com/iliaishacked/sponge_examples/blob/main/language_models/ga.py) and then modified to integrate better into our project.
Please see the original license in the `LICENSE-original` file.
Please give them the credit and cite their work:
...
from utils.image_utils import rand_images
